    ...
    e(window).on("elementor/frontend/init", function () {
        ...
        elementorFrontend.hooks.addAction(
                                    ...
                                    (function (e) {
                                        ...
                                        function n(a) {
                                            ...
                                            function l(e) {
                                                var a;
                                                if (0 == s) return !1;
                                                (a = f(e)) < 0 && (a = 0), a > i && (a = i), m(a);
                                            }
                                            function c(e) {
                                                var a;
                                                if (0 == s) return !1;
                                                (a = p(e)) < 0 && (a = 0), a > i && (a = i), m(a);
                                            }
                                            function p(e) {
                                                var t;
                                                return (
            ...
            elementorFrontend.hooks.addAction(
                ...
                function (e, a) {
                    const t = new Event("eaePopupLoaded");
                        ...
                        ($magnific = e.find(".eae-popup-link").eaePopup({
                            ...
                            callbacks: {
                                ...
                                open: function () {
                                    ...
                                    jQuery(".eae-popup-" + a + " .elementor-element");
                                    window.dispatchEvent(new Event("resize")),
                    ...
                    if (!e.hasClass("elementor-element-edit-mode"))
                        if ("countdown" === s) {
                            ...
                            if ("" !== m) {
                                ...
                                w.setTime(w.getTime() + 60 * r * 60 * 1e3);
                                var h = "expires=" + w.toUTCString();
                                document.cookie = d + "=" + m + ";" + h + ";path=/";
            ...
            elementorFrontend.hooks.addAction(
                ...
                function (e, a) {
                    var t,
                        ...
                        w = e.find(".eae-evergreen-wrapper").data("unqid"),
                        h = new Date().getTime();
                    if (!e.hasClass("elementor-element-edit-mode"))
                        if ("countdown" === d) {
